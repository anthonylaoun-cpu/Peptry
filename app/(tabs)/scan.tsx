      ...
      <View style={styles.content}>
        <Animated.View entering={FadeInDown.delay(100).springify()}>
          <TouchableOpacity onPress={() => router.push('/scanner?type=face')}>
            <LinearGradient colors={['rgba(56,189,248,0.2)', 'rgba(14,165,233,0.1)']} style={styles.scanCard}>
...
const styles = StyleSheet.create({
  ...
  scanCard: { borderRadius: 24, padding: 28, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(56,189,248,0.3)' },
  ...
  startText: { color: '#38bdf8', fontWeight: '600', fontSize: 16 },
