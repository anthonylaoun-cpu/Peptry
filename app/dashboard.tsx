      ...
      <ScrollView style={styles.scroll}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <LinearGradient colors={['#a855f7', '#7c3aed']} style={styles.headerLogo}>
        ...
        <Animated.View entering={FadeInUp.delay(200).springify()}>
          <LinearGradient colors={['rgba(168,85,247,0.2)', 'rgba(124,58,237,0.1)']} style={styles.ctaCard}>
            <LinearGradient colors={['#a855f7', '#7c3aed']} style={styles.ctaIcon}>
        ...
        <Animated.View entering={FadeInUp.delay(300).springify()} style={styles.options}>
          <TouchableOpacity onPress={() => router.push('/scanner?type=face')} style={styles.optionCard}>
            <View style={styles.optionIcon}><Ionicons name="person-outline" size={28} color="#a855f7" /></View>
          ...
          <TouchableOpacity onPress={() => isPremium ? router.push('/scanner?type=body') : router.push('/paywall')} style={styles.optionCard}>
            <View style={styles.optionIcon}><Ionicons name="body-outline" size={28} color="#a855f7" /></View>
            <View style={styles.optionContent}>
...
const styles = StyleSheet.create({
  ...
  ctaCard: { marginHorizontal: 24, marginBottom: 24, borderRadius: 24, padding: 24, borderWidth: 1, borderColor: 'rgba(168,85,247,0.3)', alignItems: 'center', paddingVertical: 32 },
  ...
  ctaButton: { borderRadius: 16, paddingVertical: 16, paddingHorizontal: 32, flexDirection: 'row', alignItems: 'center', shadowColor: '#a855f7', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, shadowRadius: 12 },
  ...
  optionIcon: { width: 56, height: 56, borderRadius: 16, backgroundColor: 'rgba(168,85,247,0.2)', alignItems: 'center', justifyContent: 'center' },
  ...
  premiumTag: { backgroundColor: 'rgba(168,85,247,0.2)', borderRadius: 99, paddingHorizontal: 8, paddingVertical: 2, marginLeft: 8 },
  premiumTagText: { color: '#c084fc', fontSize: 12 },
  optionSubtitle: { color: '#9ca3af', fontSize: 14, marginTop: 4 },
  optionAction: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
  optionActionText: { color: '#c084fc', fontSize: 14 },
