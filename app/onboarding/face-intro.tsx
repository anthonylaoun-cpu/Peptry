      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInUp.delay(400).springify()} style={styles.actions}>
          <TouchableOpacity onPress={() => router.push('/onboarding/face-scan')}>
            <LinearGradient colors={['#a855f7', '#7c3aed']} style={styles.startButton}>
...
const styles = StyleSheet.create({
  ...
  infoCard: { borderRadius: 20, padding: 24, borderWidth: 1, borderColor: 'rgba(168,85,247,0.3)', gap: 20, marginBottom: 32 },
